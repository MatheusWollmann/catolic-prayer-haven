...
const prayers = [
  {
    id: "pai-nosso",
    title: "Pai Nosso",
    excerpt: "A oração que Jesus nos ensinou, um modelo perfeito de comunicação com Deus.",
    category: "Orações Básicas"
  },
  {
    id: "ave-maria",
    title: "Ave Maria",
    excerpt: "Uma bela oração dedicada à Nossa Senhora, mãe de Jesus e nossa mãe.",
  ...
  },
  {
    id: "credo",
    title: "Creio (Credo)",
    excerpt: "Profissão de fé que resume as principais verdades da nossa crença.",
    category: "Orações Básicas"
  }
];
